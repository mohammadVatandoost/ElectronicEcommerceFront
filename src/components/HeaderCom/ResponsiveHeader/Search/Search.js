                ...
                <form onSubmit={this.searchHandler} className="form-inline" id="responsiveSearch">
                    <div className="input-group">
                        <div className="input-group-prepend">
                            <button className="btn btn-default" onClick={this.searchHandler}>
                        ...
                        <div className="input-group-append p-0 responsive-search-select">
                            <select className="form-control m-0 pr-4" dir="rtl" value={this.state.category} onChange={this.onChange} name="category">
