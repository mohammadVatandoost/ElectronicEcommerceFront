            ...
            <form onSubmit={this.searchHandler} className="form-inline">
                <div id="desktopSearch" className="input-group">
                    <div className="input-group-prepend">
                        <button className="btn btn-default" style={{height: '37.5px'}} onClick={this.searchHandler} >
                    ...
                    <div className="input-group-append" dir="rtl">
                        <select className="form-control m-0" style={{height: '37.5px'}} dir="rtl" value={this.state.category} onChange={this.onChange} name="category">
