...
class AdminControlPanel extends Component {
    ...
    componentDidMount() {
        axios.post('http://localhost:80/ariaelec/public/api/admin/control-panel',{token: this.props.token})
            .then((res) => {
                console.log('res');
                console.log(res);
    ...
    deleteCM = (email) => {
        ...
        axios.post('http://localhost:80/ariaelec/public/api/admin/cm/delete',{token: this.props.token, email: email})
            .then((res) => {
