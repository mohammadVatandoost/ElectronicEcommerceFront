            ...
            <div className="container text-right">
                ...
                <div className="flex-row space-between">
                    <div className="flex-column space-between flex-item-5">
                        ...
                        <p style={{backgroundColor: '#DFDFFD',padding: '1%'}}> مقدار مقاومت  = <span className="text-left" style={{direction: 'ltr'}}> {this.state.Res4Band.RValue} {this.state.Res4Band.RSelect}</span>  </p>
                    </div>
                    <div className="flex-column space-between flex-item-5">
                        <h2>5 بند</h2>
                    </div>
