    ...
    render() {
        ...
        for (let i = 2 ; i < this.state.CParallelNum ; i++  ) {
            capacitorParallel.push(
                <div className="flex-row flex-start margin-2 text-left">
                    <label className="flex-item-2"> C{i+1} : </label>
                    <input name="CValue" value={this.state.CParallel[i].CValue} onChange={(e) => this.onChangeCParallel(i,e)} type="number" className="form-control flex-item-6"/>
                    <select name="CSelect" value={this.state.CParallel[i].CSelect} onChange={(e) => this.onChangeCParallel(i,e)} className="form-control flex-item-2">
        ...
        for (let i = 2 ; i < this.state.CSeriesNum ; i++  ) {
            capacitorSerie.push(
                <div className="flex-row flex-start margin-2 text-left">
                    <label className="flex-item-2"> C{i+1} : </label>
                    <input name="CValue" value={this.state.CSeries[i].CValue} onChange={(e) => this.onChangeCSeries(i,e)} type="number" className="form-control flex-item-6"/>
                    <select name="CSelect" value={this.state.CSeries[i].CSelect} onChange={(e) => this.onChangeCSeries(i,e)} className="form-control flex-item-2">
                        <option value="1e-6">uF</option>
                        <option value="1e-9">nF</option>
                        <option value="1e-12">pF</option>
                    </select>
            ...
            <div className="container text-right">
                ...
                <div className="flex-row flex-start-align" style={{direction: "ltr"}}>
                    <div className="flex-column">
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label className="flex-item-2"> C1 : </label>
                            <input name="CValue" value={this.state.CParallel[0].CValue} onChange={(e) => this.onChangeCParallel(0,e)} type="number" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CParallel[0].CSelect} onChange={(e) => this.onChangeCParallel(0,e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label  className="flex-item-2"> C2 : </label>
                            <input name="CValue" value={this.state.CParallel[1].CValue} onChange={(e) => this.onChangeCParallel(1,e)} type="number" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CParallel[1].CSelect} onChange={(e) => this.onChangeCParallel(1,e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label  className="flex-item-2"> CTotal : </label>
                            <input name="CValue" value={this.state.CParallelTotal.CValue} onChange={(e) => this.onChangeCParallelTotal(e)} type="email" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CParallelTotal.CSelect} onChange={(e) => this.onChangeCParallelTotal(e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
                    ...
                    <div className="flex-column">
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label className="flex-item-2"> C1 : </label>
                            <input name="CValue" value={this.state.CSeries[0].CValue} onChange={(e) => this.onChangeCSeries(0,e)} type="number" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CSeries[0].CSelect} onChange={(e) => this.onChangeCSeries(0,e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label  className="flex-item-2"> C2 : </label>
                            <input name="CValue" value={this.state.CSeries[1].CValue} onChange={(e) => this.onChangeCSeries(1,e)} type="number" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CSeries[1].CSelect} onChange={(e) => this.onChangeCSeries(1,e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
                        ...
                        <div className="flex-row flex-start margin-2 text-left">
                            <label  className="flex-item-2"> CTotal : </label>
                            <input name="CValue" value={this.state.CSeriesTotal.CValue} onChange={(e) => this.onChangeCSeriesTotal(e)} type="email" className="form-control flex-item-6"/>
                            <select name="CSelect" value={this.state.CSeriesTotal.CSelect} onChange={(e) => this.onChangeCSeriesTotal(e)} className="form-control flex-item-2">
                                <option value="1e-6">uF</option>
                                <option value="1e-9">nF</option>
                                <option value="1e-12">pF</option>
                            </select>
